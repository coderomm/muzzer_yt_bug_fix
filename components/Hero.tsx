        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-[800px] text-gray-300 md:text-xl lg:text-2xl mt-10">
              StreamTune allows your audience to pick the soundtrack for your
              streams. Engage your viewers like never before!
            </p>
          </div>
          ...
          <div className="space-x-4">
            <Button
              className="bg-white text-black mt-8 h-[50px] text-xl hover:text-white"
